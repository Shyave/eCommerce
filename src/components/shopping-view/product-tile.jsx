                ...
                <CardContent className="p-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-sm text-muted-foreground">{
                            product?.category ? (product?.category?.charAt(0)?.toUpperCase() + product?.category?.slice(1)) : 'NA'
                        }</span>
                        <span className="text-sm text-muted-foreground">{
                            product?.brand ? (product?.brand?.charAt(0)?.toUpperCase() + product?.brand?.slice(1)) : 'NA'
                        }</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
